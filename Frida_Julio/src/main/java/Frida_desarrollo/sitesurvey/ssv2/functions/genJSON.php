...
//    $json = '{"estadoGeneral":{';
    ...
    if($nmb > 0){
        for($i = 0; $i < $nmb; $i++){
            ...
            //TIPO DE CENTRAL
            if($data['eg_tipocentral']!='Gabinete Outdoor'&&$data['eg_tipocentral']!='Contenedor'&&$data['eg_tipocentral']!='Central'&&$data['eg_tipocentral']!='Concentrador'&&$data['eg_tipocentral']!='Repetidor'){
               $data['eg_tipocentral'] = 'Otro_'.$data['eg_tipocentral']; 
            }
            ...
            if($data['eg_tipodepiso']!='Piso Firme'&&$data['eg_tipodepiso']!='Piso Falso'&&$data['eg_tipodepiso']!='Plataforma'){
               $data['eg_tipodepiso'] = 'Otro_' .$data['eg_tipodepiso'];
            }
            $estadoGeneral['tipo_piso'] = $data['eg_tipodepiso'];
            $estadoGeneral['eg_tp_coment'] = $data['eg_coment_tipodepiso'];
            //OBRA CIVIL
            if($data['eg_obracivil']!='Sala Nueva'&&$data['eg_obracivil']!='Fila Nueva'&&$data['eg_obracivil']!='Requiere Pasa Muros'&&$data['eg_obracivil']!='Entre Piso'&&$data['eg_obracivil']!='Ninguna'){
               $data['eg_obracivil'] = 'Otro_'.$data['eg_obracivil']; 
            }
...
O P T I C O  A L T O  O R D E N
 ------------------------------*/
            ...
            if($data['afo_tipo_bastidor_fibra']!='Tradicional'&&$data['afo_tipo_bastidor_fibra']!='Alta Densidad'&&$data['afo_tipo_bastidor_fibra']!='Mini DFO'){
               $data['afo_tipo_bastidor_fibra'] = 'Otro_'.$data['afo_tipo_bastidor_fibra']; 
            }
            ...
            $opticoAltoOrden['fo_final_coment'] = $data['afo_comentarios'];
/*-----------------------------
O P T I C O  B A J O  O R D E N
 ------------------------------*/
            $opticoBajoOrden['dwfo_bastidor_fibra'] = $data['bfo_bastidor_fibra'];
            if($data['bfo_tipo_bastidor_fibra'] != 'Tradicional' && $data['bfo_tipo_bastidor_fibra'] != 'Alta Densidad' && $data['bfo_tipo_bastidor_fibra']!='Mini DFO'){
               $data['bfo_tipo_bastidor_fibra'] = 'Otro_'.$data['bfo_tipo_bastidor_fibra']; 
            }
            ...
            if($data['bfo_canaleta_tipo']!='Aluminio'&&$data['bfo_canaleta_tipo']!='Acero'&&$data['bfo_canaleta_tipo']!='Charola'&&$data['bfo_canaleta_tipo']!='Plástica'){
...
M U L T I P A R
 ----------------*/
            ...
            if($data['mp_disgral']!='7 y 9 un lado versablock'&&$data['mp_disgral']!='9 y 11.5 un lado versablock'&&$data['mp_disgral']!='5 y 10 niveles portasystem'&&$data['mp_disgral']!='Exterior'){
            ...
            $multipar['mp_final_coment'] = $data['mp_comentarios'];
/*----------------
C O A X I A L
 ----------------*/
            $coaxial['cx_escalerilla_bdtd'] = $data['cx_escalerilla_bdtd'];
            if($data['cx_tipo_escalerilla_bdtd']!='Tradicional'&&$data['cx_tipo_escalerilla_bdtd']!='Alta Densidad'&&$data['cx_tipo_escalerilla_bdtd']!='Mini DFO'){
                $multipar['cx_tipo_escalerilla_bdtd'] = 'Otro_'.$data['cx_tipo_escalerilla_bdtd'];
            }
            else{
            ...
            $coaxial['cx_final_coment'] = $data['cx_comentarios'];
/*----------------------------------
G E S T I Ó N  Y  S I N C R O N Í A
 -----------------------------------*/
            ...
            $gestionSincronia['gs_final_coment'] = $data['gs_comentarios'];
/*-------------------------------------
A L I M E N T A C I Ó N  Y F U E R Z A
 --------------------------------------*/
            if($data['fz_tp_alimen']!='Planta'&&$data['fz_tp_alimen']!='Distribuidor de Fuerza (GLT)'&&$data['fz_tp_alimen']!='Remoto en Bastidor'){
                $fuerza['fz_tp_alimen'] = 'Otro_'.$data['fz_tp_alimen'];
            }
            else{
            ...
            if($data['fz_escalerilla_bdtd']!='Tierra general de piso'&&$data['fz_escalerilla_bdtd']!='Tierra general de sala'&&$data['fz_escalerilla_bdtd']!='Tierra de fila'&&$data['fz_escalerilla_bdtd']!=''){
                $fuerza['fz_escalerilla_bdtd'] = 'Otro_'.$data['fz_escalerilla_bdtd'];
            }
            else{
            ...
            $fuerza['fz_final_coment'] = $data['fz_comentarios'];
/*-----------
P L A N O S
 ------------*/
            $planos['pl_final_coment'] = $data['pl_comentarios'];
        }
    }

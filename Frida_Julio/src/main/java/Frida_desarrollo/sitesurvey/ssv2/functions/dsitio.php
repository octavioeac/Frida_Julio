...
function dsitio($dac){
    ...
    //$part = explode('|', $dac);
    $query = "SELECT edificio, clli_edif, calle, num_ext, localidad, municipio, edo, c_p, latitud, longitud FROM centrales WHERE id_ctl = ".$dac.";";
    $datos = mysql_query($query, $conectar2);

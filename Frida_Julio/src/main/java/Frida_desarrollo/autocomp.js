function asignaVariables(input,lista)
{
	...
	inputLista1=document.getElementById(input+'1');
...
function rellenaLista()
{
	...
	else
	{
		...
		{	
			...
			var ajax=nuevoAjax();
			ajax.open("POST", "autocomp.php?", true);
...
function clickLista(elemento)
{
	...
	busqueda=valor;
	inputLista.value="Buscar central...";
	inputLista1.value=valor;

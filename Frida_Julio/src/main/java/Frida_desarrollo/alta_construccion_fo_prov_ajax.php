...
include("modulo_alta_fo_prov_ajax/components/components_html.php");
include("modulo_alta_fo_prov_ajax/components/Genericos_querys_mapper.php");
?> 
...
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/funcion_busquedaArchivo.js"></script>
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/Actualiza_terminar_JavaScripts.js"></script>
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/Envia_Correo_JavaScript.js"></script>
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/Compreuba_finalizacion_envioMail.js"></script>
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/mandar_mail_nodo_acceso.js"></script>
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/checkbox_estatus.js"></script>
<script language="JavaScript" src="modulo_alta_fo_prov_ajax/JavaScript/chebox_construc.js"></script>
...
<script type="text/javascript" src="modulo_alta_fo_prov_ajax/JavaScript/pop_up.js"></script>
<script type="text/javascript" src="modulo_alta_fo_prov_ajax/JavaScript/pop_up_mail.js"></script>
<script type="text/javascript" src="modulo_alta_fo_prov_ajax/JavaScript/cierra_mail.js"></script>
<script type="text/javascript" src="modulo_alta_fo_prov_ajax/JavaScript/cierra_mail.js"></script>
<script type="text/javascript" src="modulo_alta_fo_prov_ajax/JavaScript/ajax_validaciones.js"></script>
...
<link href="modulo_alta_fo_prov_ajax/css/dialog_box.css" rel="stylesheet" type="text/css" /> 
...
function busqueda_archivo_java()
{
	...
	actualiza_terminar_refSisa('<?=$_REQUEST['ref_sisa_a']?>','<?=$_REQUEST['envia_punta']?>','validada','0');
		...
		var pop_up="modulo_alta_fo_prov_ajax/pop_up_html/pop_up_html_CAMBIO_NODO.php";
        ...
        <input type="hidden" value="<?=$_GET['tabla']?>" name="tabla" />
           <input type="hidden" value="RICARDRP@telmex.com" name="email_8" />
                <input type="hidden" value="JOSEGA@telmex.com" name="email_9" />
                   <input type="hidden" value="ealarcon@telmex.com" name="email_10" />
        </td>
	</tr>
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////INICIOPLANIFICACION  -->
	...
	<tr class="constru"><td colspan="2" bordercolor="#CAE4FF" bgcolor="#CAE4FF" class="Estilo4" align="left"><a name="ancla_cons"></a>Planificaci&oacute;n</td>
       ...
       <td id="con_plan2" class="Estilo2"> <input  id="no_requerido_plan" name="requeri_forma_plani" type="checkbox" onclick="javascript:click_plan();" value="No_Requerido"<?php if ($array_a['planifi_requerid']=='No_Requerido') { echo ' checked="checked"';} ?> />No
...
jq2('#edo_acometida option[value="<?=$array_a['edo_acometida']?>"]').prop('selected', true);
	...
	<tr>
        ...
        <input class="Estilo1" datepicker='true' name="fecha_sol_planificacion" type="text" id="fecha_sol_planificacion" value="<?php if($_REQUEST['fecha_sol_planificacion']!=''){echo $_REQUEST['fecha_sol_planificacion'];}else{echo $array_a['fecha_sol_planificacion'];}?>" /></td>
...
jq2('#estatus_planificacion option[value="'+'<?=$array_a['estatus_planificacion'] ?>'+'"]').prop('selected', true);
 ...
 <input type="button" id="Correo_ele2" value="Solicitar Planificaci&oacute;n" onclick='javascript:hola_correo();'/>
        </td>
        
	</tr>
 <script>
<?php if ($array_a['planifi_requerid']=='No_Requerido') { ?>
	  	check_box_no_requerido_plan();
<?php } else {?>
<?php } ?>
function hola_correo(){
var pop_up="modulo_alta_fo_prov_ajax/pop_up_html/pop_up_solicitar_mail.php";
		var name_id="estado_nodo"
		var funcion_name="update";
		var tabla="construccion_fo";
		var ref_sisa='<?=$_REQUEST['ref_sisa_a']?>';
		var punta='<?=$_REQUEST['envia_punta']?>';
		pop_up_dialog_mail(pop_up,name_id,funcion_name,ref_sisa,punta,tabla);
}
function click_plan()
{
if(jq("#no_requerido_plan").is(':checked')){
	...
	checbox_original_no_requerido_plan();   
}
}
</script>
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////INICIOPROYECTOS  -->
	...
	<tr class="proyectos">
		...
		<input class="Estilo1 required" name="pep_a" type="text" id="pep_a" value="<?php if($_REQUEST['pep_a']!=''){echo $_REQUEST['pep_a'];}else{echo $array_a['pep'];}?>" /><span style="font:Georgia, 'Times New Roman', Times, serif" class="span1" id="hola_span"></span></td>
       <script>
	   	
//jq2("#pep_a").focus(function() {
  jq2("#pep_a").focusout(function(){
var pos6=jq("#pep_a").val();
comprobar_campos_pes_pep_etc("siatel_str_ztmps08t003_peps",null,null,'select','array_asoc',pos6);
	});
//});	
        ...
        <span style="font:Georgia, 'Times New Roman', Times, serif" class="span1" id="hola_span2"></span>
		</td>
...
<script>
//jq2("#pedido45_a").click(function() {
jq2("#pedido45_a").focusout(function(){
var pos7=jq2("#pedido45_a").val();
comprobar_campos_pedido45_a("siatel_str_ztmps08t003_pedido",null,null,'select','array_asoc',pos7);
	});
//});		
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////INICIOCONSTRUCCION  -->
	...
	<tr class="constru"><td colspan="2" bordercolor="#CAE4FF" bgcolor="#CAE4FF" class="Estilo4" align="left"><a name="ancla_cons"></a>Construcci&oacute;n</td>
       ...
       <td id="con2" class="Estilo2">  <input  id="no_requerido" onclick="javascript:click_const();" name="requeri_forma" type="checkbox" vvalue="No_Requerido"<?php if ($array_a['cons_requerid']=='No_Requerido') { echo ' checked="checked"';} ?> />No
...
$combo_Dependencias=html_components::dinamic_select_combo(
"cat_construccion_fo", //tabla a la que llegua $tabla
"dependencia_construccion", //nombre del componente $name_componente
"dependencia_construccion",  //id del componente $id_componente
"Estilo3",  //CSS que se desea 
$valores=array(
  "valor_1"=>"2",
   "valor_2"=>"1"
   ),   //columnas
NULL, //funciones $js_script
"dependencia construccion",//REQUERIMIENTOS
NULL, //OPERADOR LOGICO
"Seleccione", //<option>  --'MENSAJE A MOSTRAR '--  </option>
NULL  //valor en  select campo from tabla where valor_1='' and valor_2='SUPERVISOR' "
); 	//nuevas opción o sin opción 
...
//echo $combo_cat_tecnic;
	...
	<?php  include('modulo_alta_fo_prov_ajax/carga_archvos_principal_prov.php') ?>
	</td></tr>
<!-- ////////////////////////////////////////////////////////////////////////////////////////FINCONSTRUCCION  -->
...
<?php if ($array_a['cons_requerid']=='No_Requerido') { ?>
	  	checkbox_construccion_inhabilita();
<?php } else {?>
<?php } ?>


function click_const()
{
if(jq("#no_requerido").is(':checked')){
	 checkbox_construccion_inhabilita();
} else {

	checkbox_construccion_habilita();   
}
}
...
include("modulo_alta_fo_prov_ajax/DAO_actualiza__Cambio_Nodo_Acceso.php");	
include("modulo_alta_fo_prov_ajax/Implements_Envia_correo.php");	
//////OT SIN VALIDAR
...
if($_REQUEST['comprobar']!='') // Comprobar PEP Y PEDIDO 45 
	{
	if ($_REQUEST['comprobar']=='PEDIDO45' )
			{
				// Query General
...
$obj_trafico_tipo= Genericos_querys_mapper::generyc_mapper_querys(
"select",
$_REQUEST['ref_sisa_a'],
$_REQUEST['envia_punta'],
"fibra_optica_ladenlaces",
 NULL,
 "array_asoc" ); 
...
$mi_array_datos_mail=array(
  ...
  for($i=0;$i<11;$i++) //numero de usuarios IPR  y supervisores name="mail_$i"hp
  { 
    $email='$email_'.$i; 
	if($email!=""){
    eval("\$email = \"$email\";"); 
...
?>
	 ...
	 jq.ajax({
   	 url:'modulo_alta_fo_prov_ajax/cargarArchivos.php',
	 type:'post',

...
$query_inserta ="insert into fibra_optica_ladenlaces ( tipo_cliente,tipo_trayec,cable,punta,ubicaciona,tipo_sel,cap_cable,longitud,tipo_jumper ,pedido45,fibra_a,fibra_b,ref_sisa,indez,cliente) values('CLIENTES',";
...
$query_inserta="insert into fibra_optica_ladenlaces ( tipo_cliente,tipo_trayec,cable,punta,ubicaciona,tipo_sel,pedido45,fibra_a,fibra_b,ref_sisa,indez,cliente) values('CLIENTES',";

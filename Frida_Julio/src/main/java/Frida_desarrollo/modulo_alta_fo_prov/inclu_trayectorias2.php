...
include("select_fibra_optica_ladenlaces.php");
include("select_contruccion_fo.php");
?>
...
<script language="JavaScript" src="JavaScript/combos_trayectorias"></script>
...
$array_trabajo_cliente=select_fibra_optica_ladaenlaces::select_cambio_nodo(
$_REQUEST['ref_sisa_a'], 
$_REQUEST['envia_punta'], 
$tabla,
$valores,
'CLIENTE (TRABAJO)');
//var_dump($array_trabajo_cliente);

/*$valores_anillo=array(
    "valor_49"=>"1"

);*/
/*$array_anillo=dao_contruccion_fo::select_dinamic_query($ref_sisa, $punta, $tabla,$valores_anillo);
  if($Row_anillo['anillo_rof']==""){
	      
	 	  $cable_cliente_trabajo=$array_anillo['anillo_rof'];
		  $cable_cliente_resplado=$array_anillo['anillo_rof'];
  }
  else{
    	 $cable_cliente_trabajo=$Row_anillo['anillo_rof']; 
	  }*/       $v_cliT_cable=$array_trabajo_cliente['cable'];
	            $v_clit_cliente=$array_trabajo_cliente['cliente'];
				$v_cliT_ubi =$array_trabajo_cliente['ubicaciona'];
				$v_cliT_capcable =$array_trabajo_cliente['cap_cable'];
				$v_cliT_long = $array_trabajo_cliente['longitud'];
				$v_cliT_jumper = $array_trabajo_cliente['tipo_jumper'];
				$v_par_fibra_clit = $array_trabajo_cliente['fibra_a']." , ".$array_trabajo_cliente['fibra_b'].""; 
				$v_cliT_f1 = $array_trabajo_cliente['fibra_a'];
				$v_cliT_f2 = $array_trabajo_cliente['fibra_b'];
				$v_cliT_pe45=$array_trabajo_cliente['pedido45'];
$array_trabajo_central=select_fibra_optica_ladaenlaces::select_cambio_nodo(
$_REQUEST['ref_sisa_a'], 
$_REQUEST['envia_punta'], 
$tabla,
$valores,
'CENTRAL (TRABAJO)');
			    $v_cenT_cliente=$array_trabajo_central['cliente']; 
				$v_cenT_cable =$array_trabajo_central['cable'];
				$v_cenT_ubi =$array_trabajo_central['ubicaciona'];
				$v_cenT_f1 = $array_trabajo_central['fibra_a'];
				$v_cenT_f2 = $array_trabajo_central['fibra_b'];
				$v_cenT_pe45 = $array_trabajo_central['pedido45'];
$array_respaldo_central=select_fibra_optica_ladaenlaces::select_cambio_nodo(
$_REQUEST['ref_sisa_a'], 
$_REQUEST['envia_punta'], 
$tabla,
$valores,
'CENTRAL (RESPALDO)');
    	      	$v_cenR_cable = $array_respaldo_central['cable'];
				$v_cenR_cliente = $array_respaldo_central['cliente'];
				$v_cenR_ubi =$array_respaldo_central['ubicaciona'];
				$v_cenR_f1 = $array_respaldo_central['fibra_a'];
				$v_cenR_f2 = $array_respaldo_central['fibra_b'];
				$v_cenR_pe45 =$array_respaldo_central['pedido45'];

$array_respaldo_cliente=select_fibra_optica_ladaenlaces::select_cambio_nodo(
$_REQUEST['ref_sisa_a'], 
$_REQUEST['envia_punta'], 
$tabla,
$valores,
'CLIENTE (RESPALDO)');
               ...
               $v_cliR_cliente =$array_respaldo_cliente['cliente'];
				$v_cliR_cable =$array_respaldo_cliente['cable'];
				$v_cliR_ubi =$array_respaldo_cliente['ubicaciona'];
				$v_cliR_capcable =$array_respaldo_cliente['cap_cable'];
				$v_cliR_long =$array_respaldo_cliente['longitud'];
				$v_cliR_jumper =$array_respaldo_cliente['tipo_jumper'];
				$v_cliR_f1 =$array_respaldo_cliente['fibra_a'];
				$v_cliR_f2 =$array_respaldo_cliente['fibra_b'];
				$v_cliR_pe45 =$array_respaldo_cliente['pedido45'];
                $v_par_fibra_clirth= $array_respaldo_cliente['fibra_a']." , ".$array_respaldo_cliente['fibra_b'].""; 
...
<!-- INICIO CLIENTE TRABAJO  -->
			<tr id="cliente_nco_trabajo">
                ...
                <input id="fo_clit_cliente" class="required" name="fo_clit_cliente" type="text" size="9" value="<?=$v_clit_cliente;?>"  /></td>
				<td width="10%" align="center" bgcolor="#CAE4FF" class="Estilo58">Nombre Cable<br />
                
                
                
     <input id="fo_clit_cable"  name="fo_clit_cable" type="text" size="9" value="<?=$v_cliT_cable;?>" /></td>
...
<script>
jq2('#fo_clit_cap option[value="<?=$v_cliT_capcable?>"]').prop('selected', true);
</script>
      ...
      <script>
jq2('#fo_clit_jump option[value="<?=$v_cliT_jumper?>"]').prop('selected', true);
</script>
		</td>
                ...
                <input name="fo_clit_ped"   type="text" id="fo_clit_ped" size="9" value=""  />
...
<!--				<select name="fo_clit_f" id="fo_clit_f" onChange="envia('ancla_cons');">-->
		...
		function(){
     	...
     	jq2('#fo_clit_f option[value="<?=$v_par_fibra_clit?>"]').prop('selected', true);
...
<!-- INICIO CENTRAL TRABAJO  -->
			<tr id="central_nco_trabajo">
                ...
                <input name="fo_cent_central" type="text" id="fo_cent_central" size="9" value="<?=$v_cenT_cliente;?>"  />
                
                </td>
				
                <td width="8%" align="center" bgcolor="#CAE4FF" class="Estilo58">Nombre Cable<br />
                
                <input id="fo_cent_cable" name="fo_cent_cable" type="text" size="9" value="<?=$v_cenT_cable?>"  />
              ...
              <!--  <input name="fo_cent_ped" type="text" id="fo_cent_ped" size="9" value="<php if($_REQUEST['fo_cent_ped']!=''){echo $_REQUEST['fo_cent_ped'];}else{echo $v_cenT_pe45;}?>" onchange="document.solicita.comprobar.value='PEDIDO45_TRAY'; document.solicita.campo_tray.value='fo_cent_ped'; document.solicita.submit();" />-->
                               ...
                               <input name="fo_cent_ped" type="text" id="fo_cent_ped" size="9" value="" />
...
<!-- INICIO CLIENTE RESPALDO  -->
			<tr id="cliente_nco_respaldo">
				...
				<td width="10%" align="center" bgcolor="#CAE4FF" class="Estilo58">Cliente<br />
                <input id="fo_clir_cliente" name="fo_clir_cliente" type="text" size="9" value="<?=$v_cliR_cliente;?>" />
                
                
                </td>
				<td width="8%" align="center" bgcolor="#CAE4FF" class="Estilo58">Nombre Cable<br />
                
                <input id="fo_clir_cable" name="fo_clir_cable" type="text" size="9" value="<?=$v_cliR_cable?>"  />
              ...
              <input  id='fo_clir_ubi_1' name='fo_clir_ubi_1' type="hidden" value='<? echo $v_cliR_ubi; ?>' size='19' maxlength='19' readonly='readonly'>    
				...
				<td width="7%" align="center" bgcolor="#CAE4FF" class="Estilo58">Cap Cable<br />
				                    ...
				                    <select id="fo_clir_cap" name="fo_clir_cap" >
						  <option value="">Seleccione</option>
        			<?php
		 $query = "select * from trayecto_fibra_optica where fo_componente_trayecto_fibra_optica='fo_clit_cap_num'";
     	$result = mysql_query($query);
      ...
      { 
         ...
         <script>
		 jq2('#fo_clir_cap option[value="<?=$v_cliR_capcable?>"]').prop('selected', true);
	/*	 agrega_opciones();
      ...
      { 
        ...
        <script>
        	jq2('#fo_clir_jump option[value="<?=$v_cliR_jumper?>"]').prop('selected', true);
		</script> 
               ...
               <!-- <input name="fo_clir_ped" type="text" id="fo_clir_ped" size="9" value="<php if($_REQUEST['fo_clir_ped']!=''){echo $_REQUEST['fo_clir_ped'];}else{echo $v_cliR_pe45;}?>" onchange="document.solicita.comprobar.value='PEDIDO45_TRAY'; document.solicita.campo_tray.value='fo_clir_ped'; document.solicita.submit();" />-->
                <input name="fo_clir_ped" type="text" id="fo_clir_ped" size="9" value="" />
	...
	jq2('#fo_clir_f option[value="<?=$v_par_fibra_clirth?>"]').prop('selected', true);
	</script>
...
<!-- INICIO CENTRAL RESPALDO  -->
			<tr id="central_nco_respaldo">
                ...
                <input name="fo_cenr_central" type="text" id="fo_cenr_central" size="9" value="<?=$v_cenR_cliente;?>"   />
                
                
                </td>
				<td width="8%" align="center" bgcolor="#CAE4FF" class="Estilo58">Nombre Cable<br />
                <input id="fo_cenr_cable"  name="fo_cenr_cable" type="text" size="9" value="<?=$v_cenR_cable?>" /></td>
				<td align="center" bgcolor="#CAE4FF" class="Estilo58">Ubicacion<br />
  ...
  <input type='hidden' id='fo_cenr_ubi_1' name='fo_cenr_ubi_1' value='<? echo $v_cenR_ubi; ?>' size='19' maxlength='19' readonly='readonly'>              
                ...
                <input name="fo_cenr_ped" type="text" id="fo_cenr_ped" size="9" value="" />

...
echo "<tr bordercolor='#CAE4FF' bgcolor='#CAE4FF'>";
	...
	//GRUPO
	echo "<td><select name='grupo' id='grupo' class='Estilo48' class='Estilo48' onchange='concatena()' >";
	if ($grupo=='') $selec='selected'; else $selec='';
	echo "<option value='' $selec>-Grupo-</option>";
	if ($grupo=='grupo') $selec='selected'; else $selec='';
...
var ubicacion=piso+"."+sala+"."+grupo+fila+lado+bastidor+"."+repisa1;

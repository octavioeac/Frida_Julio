...
class PDF_SiteSurvey extends TCPDF {
	...
	public function __construct($folio){
		...
		$this->SetHeaderData('telmex.png', '20', 'TELÉFONOS DE MÉXICO S.A.B. DE C.V.', "SITE SURVEY ".$folio);
	...
	public function Footer() { //Sobreescribe la función default Footer para agregar la fecha del documento al pie de página
		$cur_y = $this->y;
	...
	private function PagEstadoGeneral(){
		...
		$cadena=$this->estilo.
			...
			<tr><td class="t" width="15%"><b>Divisional</b></td><td class="t" width="25%"><b>&Aacute;rea</b></td><td class="t" width="35%"><b>Central</b></td><td class="t" width="10%"><b>Siglas</b></td><td class="c" rowspan="3" width="15%"><b>Folio<br>'.$this->folio.'</b><br>v.'.$this->ds['version'].'</td></tr>
			...
			<tr><td class="t" width="14%"><b>Responsable</b></td><td class="t" width="30%"><b>Nombre</b></td><td class="t" width="30%"><b>Correo</b></td><td class="t" width="13%"><b>Tel.</b></td><td class="t" width="13%"><b>M&oacute;vil</b></td></tr>
			<tr><td> Proyecto</td><td> '.$this->ds['ctnombre'].'</td><td class="c">'.$this->ds['ctemail'].'</td><td class="c">'.$this->ds['cttelefono'].'</td><td class="c">'.$this->ds['ctmovil'].'</td></tr>
			<tr><td> En Sitio</td><td> '.$this->ds['rsnombre'].'</td><td class="c">'.$this->ds['rsemail'].'</td><td class="c">'.$this->ds['rstelefono'].'</td><td class="c">'.$this->ds['rsmovil'].'</td></tr>
			<tr><td> Proveedor Eq.</td><td> '.$this->ds['cpnombre'].'</td><td class="c">'.$this->ds['cpemail'].'</td><td class="c">'.$this->ds['cptelefono'].'</td><td class="c">'.$this->ds['cpmovil'].'</td></tr>
			<tr><td> Proveedor Infra.</td><td> '.$this->ds['cpinombre'].'</td><td class="c">'.$this->ds['cpiemail'].'</td><td class="c">'.$this->ds['cpitelefono'].'</td><td class="c">'.$this->ds['cpimovil'].'</td></tr>
			</table>'.
			$this->ccemail().
			$this->espacio.
			$this->ubxeq().
			$this->espacio.
                        ...
                        . '<tr><td class="t" width="20%"><b>Cable</b></td><td class="t" width="10%"><b>Tipo Material</b></td><td class="t" width="10%"><b>Nva / Exis</b></td><td class="t" width="10%"><b>Saturado</b></td><td class="t" width="10%"><b>Altura</b></td>'
                        . '<td class="t" width="10%"><b>Largo Trayectoria</b></td><td class="t" width="10%"><b>Ancho Esc/Canal</b></td><td class="t" width="10%"><b>No. Bajantes Requeridas</b></td><td class="t" width="10%"><b>Ancho Bajante</b></td></tr>'
                        . $labels->cadena
                        . '</tr></table>'.
			$this->ArmarTabla05($this->ds['eg_coment_can']).
			$this->espacio.
			'<table border="1">
			...
			$this->ArmarTabla01(array('Piso Firme','Piso Falso','Plataforma'),$this->ds['eg_tipodepiso'],'Tipo de Piso en Sitio',$this->ds['eg_coment_tipodepiso']).
			$this->ArmarTabla01(array('Sala Nueva','Fila Nueva','Requiere Pasa Muros','Entre Piso','Ninguna'),$this->ds['eg_obracivil'],'Obra Civil Requerida',$this->ds['eg_coment_obracivil']).
	...
	private function PagAltoOrdenOptico(){
			...
			$cadena = $this->estilo.
			'<table border="1">
			<tr><th><b>CONEXI&Oacute;N DE ALTO ORDEN (&Oacute;PTICO)</b></th></tr>'.
			'</table>'.
			$this->espacio.
			'<table border="1">
			<tr><th colspan="3"><b>BASTIDOR DE FIBRAS</b></th></tr>
			<tr>
			...
			$this->espacio.
			'<table border="1">
			<tr><th colspan="9"><b>TABLA DE TRASPASOS / REMATES &Oacute;PTICOS</b><br>(del equipo hacia la Red de TX)</th></tr>
			<tr>
            <td class="t" width="27%"><b>&nbsp;<br>Equipo</b></td>
            <td class="t" width="15%"><b>Ubicaci&oacute;n<br>Bastidor Fibras <br>DFO</b></td>
            <!--<td class="t" width="8%"><b>&nbsp;<br>DFO</b></td>-->
            <td class="t" width="8%"><b>Posici&oacute;n<br>de<br>Remate</b></td>
            <td class="t" width="8%"><b>Conector<br>lado<br>Equipo</b></td>
            <td class="t" width="8%"><b>Tipo<br>de<br>Fibra</b></td>
            <td class="t" width="8%"><b>Conector<br>lado<br>DFO</b></td>
            <td class="t" width="10%"><b>Bloque DFO<br>Nvo / Exist</b></td>
            <td class="t" width="8%"><b>Long.<br>Jumpers<br>Ruta 1</b></td>
            <td class="t" width="8%"><b>Long.<br>Jumpers<br>Ruta 2<br>(opcional)</b></td>
			</tr>'.
			$this->abfo(1).
			'</table>'.
	...
	private function PagBajoOrdenOptico(){
		...
		$cadena = $this->estilo.
			'<table border="1">
			<tr><th colspan="3"><b>CONEXI&Oacute;N BAJO ORDEN (&Oacute;PTICO)</b><br>Del Equipo hacia la Red de Acceso / Servicios</th></tr>
			<tr><td colspan="3" class="gc">BASTIDOR DE FIBRAS</td></tr>
			<tr>
			...
			'<table border="1">
			<tr><td colspan="9" class="gc">TRASPASOS / REMATES &Oacute;PTICOS</td></tr>
			<tr><th colspan="9">TABLA DE TRASPASOS / REMATES &Oacute;PTICOS</th></tr>
			<tr>
            <td class="t" width="24%"> <br>Equipo</td>
            <td class="t" width="18%">Ubicaci&oacute;n<br>bastidor fibras <br>DFO</td>
            ...
            <td class="t" width="10%"> Bloque DFO<br>Nvo / Exist</td>
	...
	private function PagBajoOrdenMultipar(){
		...
		$cadena=$this->estilo.
			...
			$this->espacio.
			'<table border="1">
			<tr><th colspan="2"><b>DISTRIBUIDOR GENERAL</b></th></tr>
			<tr>
			<td><table border="1">'.$this->ArmarTabla02(array('Existente','Nuevo'),$this->ds['mp_dgral'],'Se utilizar&aacute; DG').$this->ArmarTabla02(array('Si','No'),$this->ds['mp_ampvertical'],'Requiere Ampliaci&oacute;n de Verticales').'</table></td>
			<td><table border="1">'.$this->ArmarTabla02(array('7 y 9 un lado versablock','9 y 11.5 dos lados versablock','5 y 10 niveles portasystem'),$this->ds['mp_disgral'],'Tipo de Distribuidor General').'</table></td>
			</tr>
			</table>'.
			$this->espacio.
			/*'<table border="1">
	...
	private function PagBajoOrdenCoaxial(){
		...
		$cadena=$this->estilo.
			...
			<td class="t">Tipo Coaxial</td><td class="t">Tx / Rx</td>
	...
	private function PagGestion(){
		...
		$cadena = $this->estilo.
			'<table border="1">
			<tr><th colspan="6"><b>GESTI&Oacute;N Y SINCRON&Iacute;A</b></th></tr></table>'.
			$this->espacio.
			'<table border="1">
			<tr><th colspan="6"><b>GESTI&Oacute;N</b></th></tr>'.
			'<tr><td colspan="2"><table border="1">'.$this->ArmarTabla02(array('Si','No'),$this->ds['gs_requieregestion'],'Requiere Gesti&oacute;n').'</table></td>'.
				'<td colspan="2"><table border="1">'.$this->ArmarTabla02(array('En Banda','Fuera de Banda'),$this->ds['gs_tipogestion'],'Tipo de Gesti&oacute;n').'</table></td>'.
				'<td colspan="2"><table border="1">'.$this->ArmarTabla02(array('Existente','Nuevo'),$this->ds['gs_puertoRCDT'],'Puerto RCDT').'</table></td>'.
			'</tr></table>'.
			$this->espacio.
			'<table border="1">
			<tr><th colspan="6"><b>SINCRON&Iacute;A Y ALARMAS</b></th></tr>
			<tr><td colspan="2"><table border="1">'.$this->ArmarTabla02(array('Si','No'),$this->ds['gs_requieresincronia'],'Conexi&oacute;n Adicional Sincron&iacute;a').'</table></td>'.
				'<td colspan="2"><table border="1">'.$this->ArmarTabla02(array('Si','No'),$this->ds['gs_cnaddalarmas'],'Conexi&oacute;n Adicional de Alarmas').'</table></td>'.
				'<td colspan="2"><table border="1"></table></td>'.
			'</tr></table>'.
			$this->espacio.
			'<table border="1">
			<tr><th colspan="7"><b>TABLA DE REMATES DE GESTI&Oacute;N</b></th></tr>
			<tr>
            <td class="t" width="25%"><b>Equipo</b></td>
            <td class="t" width="15%"><b>Ubic. Bast. RCDT</b></td>
            <td class="t" width="12%"><b>No. Switch</b></td>
            <td class="t" width="12%"><b>Puerto</b></td>
            <td class="t" width="12%"><b>Cat. Cable</b></td>
            <td class="t" width="12%"><b>Long. de Cable</b></td>
            <td class="t" width="12%"><b>Tipo Conector</b></td>
			</tr>'.
			$this->gestionSincronia(0).
			'<tr><th colspan="7"><b>TABLA DE REMATES DE SINCRONIA</b></th></tr>
			<tr>
            <td class="t"><b>Equipo</b></td>
            <td class="t"><b>Ubic. Bastidor</b></td>
            <td class="t"><b>Repisa</b></td>
            <td class="t"><b>Puerto</b></td>
            <td class="t"><b>Tipo Cable</b></td>
            <td class="t"><b>Long. de Cable</b></td>
            <td class="t"><b>Tipo Conector</b></td>
			</tr>'.
	...
	private function PagAlimentacion(){
		...
		$cadena =$this->estilo.
			'<table border="1">
			<tr><th colspan="4"><b>ALIMENTACI&Oacute;N Y TIERRAS</b></th></tr>
			</table>'.
			$this->espacio.
			'<table border="1">
			<tr><th colspan="2"><b>ALIMENTACI&Oacute;N</b></th><th colspan="2"><b>TIERRAS</b></th></tr>'.
			'<tr><td colspan="2"><table border="1">'.$this->ArmarTabla02(array('Planta','Distribuidor de Fuerza (GLT)','Remoto en Bastidor'),$this->ds['fz_tp_alimen'],'Tipo de Alimentaci&oacute;n').'</table></td>'.
				'<td colspan="2"><table border="1">'.$this->ArmarTabla02(array('Tierra general de piso','Tierra general de sala','Tierra de fila','Tierra en repisa'),$this->ds['fz_escalerilla_bdtd'],'Tipo de Tierras').'</table></td>'.
			'</tr></table>'.
			$this->espacio.
			'<table border="1">
			<tr><th>CONFIGURACI&Oacute;N DE LA PLANTA</th><th>CONSUMO ACTUAL</th><th>LONGITUD CABLE TIERRAS</th></tr>
			<tr><td class="c">'.$this->ds['fz_configplanta'].'</td><td class="c">'.$this->ds['fz_consumo'].'</td><td class="c">'.$this->ds['fz_longcabletierra'].'</td></tr>
			</table>'.
			$this->espacio.
			/*'<table border="1">
	...
	private function PagReporteFotografico(){
		$query = "SELECT * FROM zarchivos where folio = '".$this->folio."' and tipo like 'image%' ORDER BY id,tipo";
        $result = mysql_query($query);
	...
	private function PagResumen(){
		...
		$cadena=$this->estilo.
			'<table border="1">
			<tr><th colspan="1"><b>ANTEPROYECTO</b></th></tr>
...
";*/
	...
	private function ArmarTabla01($opciones,$select,$titulo,$comentarios){
        ...
        $sz = count($opciones);
        $cadena = '<tr><th colspan="2" width="35%" class="t"><b>'.$titulo.'</b></th><th width="%65"  class="t"><b>Comentarios</b></th></tr>';
        $r = 0;$c=0;
        ...
        for($i = 0; $i < $sz; $i++){
            ...
            $cadena .= '<tr><td width="30%"> '.$opciones[$i].'</td><td class="gc" width="5%"><b>'.$x.'</b></td>'.$row.'</tr>';
            $c++;
        }
	...
	private function ArmarTabla02($opciones,$select,$titulo){
		$sz = count($opciones);
        $c=0;
        $cadena = '<tr><th colspan="2" class="t"><b>'.$titulo.'</b></th></tr>';
        foreach($opciones as $val){
            if($val == $select){
                $x = 'X';
            }
            ...
            $cadena .= '<tr><td  width="80%"> '.$val.'</td><td class="gc"  width="20%"><b>'.$x.'</b></td></tr>';
            if($c == $sz && $select != 'N/A'){
                $cadena .= '<tr><td  width="80%"><b> OTRO: '.strtoupper($val).'</b></td><td class="gc"  width="20%"><b>'.$x.'</b></td></tr>';
            }
        }
        return $cadena;
	}
	...
	private function ArmarTabla05($comentarios){
        $comentarios = $comentarios == 'N/A' ? '' : $comentarios;
        return $cadena = '<table border="1"><tr><th class="t"><b>Comentarios</b></th></tr><tr><td height="80">'.$comentarios.'</td></tr></table>';
    }
	...
	private function ubxeq(){
        $cadena = '';
        $query = "SELECT ztecnologias.tipo_equipo, zss_equipos.ubicacion,zss_equipos.nuevoExistente,zss_equipos.nombre_equipo,zss_equipos.puertos,zss_equipos.tarjetas,zss_equipos.espacio FROM ztecnologias,zss_equipos WHERE zss_equipos.folio='".$this->folio."' AND zss_equipos.id_tecnologia = ztecnologias.id order by zss_equipos.id asc";
        $result = mysql_query($query);
        $sz = mysql_num_rows($result);
        if($sz > 0){
	...
	private function abfo($ab){
        $cadena='';
        $arr = array();
		$sql="SELECT a.nombre_equipo as equipo,b.tipo_equipo as modelo,c.* FROM zss_equipos a left join ztecnologias b on a.id_tecnologia = b.id left join zinter_abfo c on a.id=c.id_equipo WHERE a.folio='".$this->folio."' AND c.alto_bajo=$ab order by a.id asc;";
		$result=mysql_query($sql);
		while($renglon=mysql_fetch_assoc($result,MYSQL_BOTH)){
			$cadena .='<tr>';
            $cadena .= '<td class="c">'.$renglon['equipo'].'</td>';
			$cadena .= '<td class="c">'.$renglon['ubicacion'].'</td>';
			$cadena .= '<td class="c">'.$renglon['tipo_conector_equipo'].'</td>';
			$cadena .= '<td class="c">'.$renglon['posicion_remate'].'</td>';
			$cadena .= '<td class="c">'.$renglon['tipo_fibra'].'</td>';
			$cadena .= '<td class="c">'.$renglon['tipo_conector_bdfo'].'</td>';
			$cadena .= '<td class="c">'.$renglon['bloque_dfo'].'</td>';
			$cadena .= '<td class="c">'.$renglon['long_jumper_1'].'</td>';
			$cadena .= '<td class="c">'.$renglon['long_jumper_2'].'</td>';
            $cadena .='</tr>';
		}
		/*
        ...
        if($sz > 0){
			...
			$subquery = "SELECT zss_equipos.nombre_equipo as equipo,ztecnologias.tipo_equipo as modelo FROM ztecnologias,zss_equipos WHERE zss_equipos.folio='".$this->folio."' AND zss_equipos.id_tecnologia = ztecnologias.id";
        ...
        if($sz2 > 0){
            for($i = 0; $i < $sz2; $i++){
                ...
                $arr[$i][2] = $d2['tipo_conector_equipo'];
                $arr[$i][3] = $d2['posicion_remate'];
                $arr[$i][4] = $d2['tipo_fibra'];
                $arr[$i][5] = $d2['tipo_conector_bdfo'];
                $arr[$i][6] = $d2['bloque_dfo'];
                $arr[$i][7] = $d2['long_jumper_1'];
                $arr[$i][8] = $d2['long_jumper_2'];
				$arr[$i][9] = $d2['dfo'];
            }
        }
        for($i = 0; $i < $total; $i++){
	...
	private function Multipar(){
        $tabla = '<table border="1"><tr><th colspan="9"><b>TABLA DE REMATES MULTIPAR</b></th></tr>
			<tr><td class="t" rowspan="2" width="27%"><b>Equipo</b></td>
				<td class="t" rowspan="2" width="10%"><b>Tipo tablilla</b></td>
				<td class="t" rowspan="2" width="9%"><b>Longitud<br>de Cable</b></td>
				<td class="t" colspan="3" width="27%"><b>POTS</b></td>
				<td class="t" colspan="3" width="27%"><b>DSL</b></td>
			</tr>
			<tr><td class="t" width="9%"><b>Nivel</b></td>
				<td class="t" width="9%"><b>Vertical</b></td>
				<td class="t" width="9%"><b>Puertos</b></td>
				<td class="t" width="9%"><b>Nivel</b></td>
				<td class="t" width="9%"><b>Vertical</b></td>
				<td class="t" width="9%"><b>Puertos</b></td>
			</tr>';
		$a=array();
		$sql="SELECT a.nombre_equipo as equipo,b.tipo_equipo as modelo,d.r,c.* 
		FROM zss_equipos a 
		left join ztecnologias b on a.id_tecnologia = b.id 
		left join (select * from zinter_mp a2 where a2.folio='".$this->folio."' and a2.pots_dsl=0) c on a.id=c.id_equipo
		left join (select a1.id_equipo,ceil(count(*)/2) as r from zinter_mp a1 where a1.folio='".$this->folio."' group by id_equipo) d on c.id_equipo=d.id_equipo
		WHERE a.folio='".$this->folio."' order by a.id asc, c.id asc;";
		$result=mysql_query($sql);
		$n1=0;
		...
		FROM zss_equipos a 
		left join ztecnologias b on a.id_tecnologia = b.id 
		left join (select * from zinter_mp a2 where a2.folio='".$this->folio."' and a2.pots_dsl=1) c on a.id=c.id_equipo
		left join (select a1.id_equipo,ceil(count(*)/2) as r from zinter_mp a1 where a1.folio='".$this->folio."' group by id_equipo) d on c.id_equipo=d.id_equipo
		WHERE a.folio='".$this->folio."' order by  a.id asc, c.id asc;";
		$result=mysql_query($sql);
		while($renglon=mysql_fetch_assoc($result)){
		...
		if($n1==$n2){
			...
			for ($i=0; $i<$n1; $i++){
				$tabla.="<tr>";
				if(($i+$op)%$op==0){
					$tabla.="<td rowspan=\"".$op."\" class=\"c\">".$a['p'][$i]['equipo']."</td>";
					$tabla.="<td rowspan=\"".$op."\" class=\"c\">".$a['p'][$i]['tipo_tablilla']."</td>";
					$tabla.="<td rowspan=\"".$op."\" class=\"c\">".$a['p'][$i]['long_cable']."</td>";
				}
				$tabla.="<td class=\"c\">".$a['p'][$i]['nivel']."</td>";
				$tabla.="<td class=\"c\">".$a['p'][$i]['vertical']."</td>";
				$tabla.="<td class=\"c\">".$a['p'][$i]['puertos']."</td>";
				$tabla.="<td class=\"c\">".$a['d'][$i]['nivel']."</td>";
				$tabla.="<td class=\"c\">".$a['d'][$i]['vertical']."</td>";
				$tabla.="<td class=\"c\">".$a['d'][$i]['puertos']."</td>";
				$tabla.="</tr>";
			}
			$tabla.="</table>";
		}
		else echo "Error en cantidad registros multipar ";
        // $query = "SELECT a.id,a.nombre_equipo,b.long_cable,c.puertos_max FROM zss_equipos a left join (SELECT * FROM zinter_mp WHERE folio='".$this->folio."' GROUP BY id_equipo) b on a.id=b.id_equipo left join ztecnologias c on a.id_tecnologia=c.id where a.folio = '".$this->folio."' AND a.id_tecnologia != 0";
        // $result = mysql_query($query);
        // $sz = mysql_num_rows($result);
        // if($sz > 0){
            // for($i = 0; $i < $sz; $i++){
                ...
                // if($sz2 > 0){
					...
					// //$renglones=$d['puertos_max']/ PoRTASYSTEM O VERSABLOCK
                    // $tabla .= '<tr><td align="center" rowspan="'.($sz2/2).'">'.$d['nombre_equipo'].'</td><td align="center" rowspan="'.($sz2/2).'">'.$sel.'</td><td align="center" rowspan="'.($sz2/2).'">'.$d['long_cable'].'</td>';
                    // for($j = 0; $j < $sz2; $j++){
                        // $d2 = mysql_fetch_array($result2);
                        // if($j%2 == 0 && $j == 0){
	...
	private function gestionSincronia($gs){
        $arr = array();
		$sql="SELECT a.nombre_equipo as equipo,b.tipo_equipo as modelo,c.* FROM zss_equipos a left join ztecnologias b on a.id_tecnologia = b.id left join zinter_gs c on a.id=c.id_equipo WHERE a.folio='".$this->folio."' AND c.gestionSincronia=$gs order by a.id asc;";
		// echo $sql;
		$result=mysql_query($sql);
		while($renglon=mysql_fetch_assoc($result,MYSQL_BOTH)){
			$cadena .='<tr>';
    ...
    private function Fuerza(){
		$a=array();
		$sql="SELECT a.nombre_equipo as equipo,b.tipo_equipo as modelo,d.r,if(c.trabajo_respaldo=0,\"Trab\",\"Resp\") as trabajo_respaldo,c.ub_alimen,c.nuevo_existente,c.pf_breaker,if(c.cap_fusible=\"Seleccionar\",\"\",c.cap_fusible) as cap_fusible,if(c.calibre=\"Seleccionar\",\"\",c.calibre) as c_calibre,c.l_cable,c.c_cable,if(c.t_zapata=\"Seleccionar\",\"\",c.t_zapata) as t_zapata
			FROM zss_equipos a 
			left join ztecnologias b on a.id_tecnologia = b.id 
			left join (select * from zinter_fz a2 where a2.folio='".$this->folio."') c on a.id=c.id_equipo
			left join (select a1.id_equipo,2 as r from zinter_fz a1 where a1.folio='".$this->folio."' group by id_equipo) d on c.id_equipo=d.id_equipo
			WHERE a.folio='".$this->folio."' order by a.id asc, c.trabajo_respaldo asc;";
		// echo $sql;
		$result=mysql_query($sql);
		...
		if($n1>0){
			...
			<tr><th colspan="9"><b>TABLA DE POSICIONES DE ALIMENTACI&Oacute;N</b></th></tr>
			<tr>
            <td class="t" width="19%"><b>Equipo</b></td>
			<td class="t" width="5%"><b>Tipo</b></td>
            <td class="t" width="15%"><b>Ubicaci&oacute;n</b></td>
			<td class="t" width="8%"><b>Nvo/Exist</b></td>
			<td class="t" width="8%"><b>Posici&oacute;n</b></td>
            <td class="t" width="8%"><b>Capacidad de Fusible</b></td>
			<td class="t" width="8%"><b>Calibre de Cable</b></td>
            <td class="t" width="8%"><b>Long. del Cable de Fza.</b></td>
			<td class="t" width="8%"><b>Cant. de Cables</b></td>
            <td class="t" width="13%"><b>Tipo de Zapata</b></td>
			</tr>';
			$op=$a['f'][0]['r'];
			for ($i=0; $i<$n1; $i++){
				$cadena.="<tr>";
				if(($i+$op)%$op==0){
					$cadena.="<td rowspan=\"".$op."\" class=\"c\">".$a['f'][$i]['equipo']."</td>";
				}
				$cadena.="<td class=\"c\">".$a['f'][$i]['trabajo_respaldo']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['ub_alimen']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['nuevo_existente']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['pf_breaker']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['cap_fusible']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['c_calibre']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['l_cable']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['c_cable']."</td>";
				$cadena.="<td class=\"c\">".$a['f'][$i]['t_zapata']."</td>";
				$cadena.="</tr>";
			}
			$cadena.="</table>";
		}
		else echo "Error en cantidad registros fz";
        ...
        // $query = "SELECT ztecnologias.id, zss_equipos.nombre_equipo as equipo,ztecnologias.tipo_equipo as modelo FROM ztecnologias, zss_equipos WHERE zss_equipos.folio = '".$this->folio."' AND zss_equipos.id_tecnologia = ztecnologias.id";
        // $result = mysql_query($query);
        // $sz = mysql_num_rows($result);
        // if($sz > 0){
            // for($i = 0; $i < $sz; $i++){
...
if ($folio==null) echo "Error, folio nulo";
    ...
    if(mysql_num_rows($r)==0){
		...
		// include('uni_pdf.php');
        // $pdf=new PDF_SiteSurvey($folio);
		// $output_PDF_tem='ReporteSiteSurvey_'.$folio.'_tem.pdf';

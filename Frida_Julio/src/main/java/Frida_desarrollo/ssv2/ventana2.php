...
<html>
	...
	<?php
        ...
        ?>
        <div id="container">
            <form id="winone" name="winone" method="post" action="ventana2.php">
                ...
                <ul class="contc">
                    ...
                    <li><input type="text" class="validate[required] text" name="noprov_i" size="30"/></li>
					<li><input type="text" class="validate[required,custom[email]] text" name="mailprov_i" size="25"/></li>
                ...
                <div id="ctcnt"> 
                    <fieldset class="contact">
                        ...
                        <label style="width:121px">Fecha Propuesta<span class="x">*</span></label><!-- class="validate[required,custom[date]]" -->
                        <input style="margin-left:40px" type="text" id="datepicker" name="fecha_solicitud"/>
                    </fieldset>
                    <fieldset class="contact">
                        <legend class="hf">&nbsp;</legend>
                        <label style="width:121px">Hora Propuesta<span class="x">*</span></label><!-- class="validate[required,custom[date]]" -->
                ...
                <fieldset>
                    ...
                    <label class="large">Elemento PEP <span class="x">*</span></label><input type="text" id="pep" name="pep" class="validate[required,custom[pep]]"/>
                </fieldset>
                ...
                <fieldset class="nu">
                    ...
                    <div class="two">
                        <label>Rubro:</label>
                        <select id="rubro" name="rubro" disabled>
                            <option value="">Seleccionar</option>
                    ...
                    <div class="two">
                        ...
                        <select id="noequipos" name="noequipos" disabled><option value="">Seleccionar</option></select>
                    </div>
                    <div class="two">
                        <label>Proveedor:</label>
                        <select id="proveedor" name="proveedor"  disabled></select>
                    </div>
                    <div class="two">
                        <label>Tecnologia:</label>
                        <select id="tecnologia" name="tecnologia" disabled></select>
                    </div>
                </fieldset>
...
//            }            
            ...
            guardarss($folio,$tipoSiteSurvey,$plan,$nrubro,$central,$ctnombre,$cttelefono,$ctemail,$ctmovil,$rsnombre,$rstelefono,$rsemail,$rsmovil,$cpnombre,$cptelefono,$cpemail,$cpmovil,$fecha_programada,$punto_reunion,$proveedor,$modelo,$pep,1,$division,$cpinombre,$cpitelefono,$cpimovil,$cpiemail);

...
$sql="UPDATE inversion.metas SET META_TOT=META_REM+META_ACT";
...
class jqgrid
{
	...
	var $table;
	// Acciones permitidas en el gris
	var $actions;
	...
	/**
	 * Setter para las opciones de personalización del grid
	 */
	...
	/**
	 * Generar automáticamente las columnas de cuadrícula basado en SQL / table
	 */
	function set_columns($cols = null)
	{
		...
		// Si la tabla sólo está definido, seleccione SQL para hacerlo

...
class jqgrid
{
	...
	?>
		...
		// show/hide columns
		jQuery("#<?php echo $grid_id?>").jqGrid('navButtonAdd',"#<?php echo $grid_id."_pager"?>",{caption:"Columnas",title:"Mostrar/Ocultar Columnas", buttonicon :'ui-icon-note',
			onClickButton:function(){
				//jQuery("#<?php echo $grid_id?>").jqGrid('setColumns',{colnameview : false}); 
				jQuery("#<?php echo $grid_id?>").jqGrid('setColumns',{colnameview : false,width:300});
			} 
		});
		<?php } ?>

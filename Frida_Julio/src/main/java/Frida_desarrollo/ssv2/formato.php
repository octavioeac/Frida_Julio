    ...
    <body>
        ...
        <div id="main">
            ...
            <table>
                ...
                <tr>
                    <td class="h" rowspan="4" style="width:200px"><img src="<?echo $imgLogo?>" alt="<?echo $altLogobgcolor = '#AED7FF'?>"/></td>
                    <td class="t">DD</td>
                    <td class="t">&Aacute;REA</td>
                    <td class="t">CENTRAL</td>
                    <td class="t" style="width:9%">SIGLAS</td>
                    <td class="h" rowspan="4" style="width:16%"><?php echo '<b style="color:#f00;font-size:17px">'.$folio.' V.'.$datos[29].'</b><br/><br/><div id="'.$datos[17].'" class="estatus">'.$datos[17].'</div>' ?></td>
                </tr>
                <tr>
            ...
            <table>
                ...
                <tr>
                    <td>Responsable Proveedor Equipo</td>
				...
				<tr>
                    <td>Responsable Proveedor Infraestructura</td>
                    <td><?php echo $datos[25]?></td>
                    <td><?php echo $datos[26]?></td>
                    <td><?php echo $datos[27]?></td>
                    <td><?php echo $datos[28]?></td>
                </tr>
                <tr>
            ...
            <div id="tabs">
                ...
                <div id="tabs-1">
                    ...
                    <ul class="can">
                        ...
                        <li class="blu">ANCHO TRAYECTORIA</li>
                        <li class="blu">No. BAJANTES</li>
                        <li class="blu">ANCHO BAJANTES</li>
                        <!--ALTO ORDEN FO-->
                        <li class="sky sfo">FIBRA OPTICA (ALTO ORDEN)</li>
                        <li class="sfo">
                            <select name="sfoslc">
                        ...
                        <!--BAJO ORDEN FO-->
                        <li class="sky mfo">FIBRA OPTICA (BAJO ORDEN)</li>
                        <li class="mfo">
                            <select name="mfoslc">
                                <option value="0">Seleccionar</option>
                                <option value="1">Aluminio</option>
                ...
                <div id="tabs-2">
                    <div class="conttwo">
                        <div class="lf">
                            ...
                            <div class="l" id="a2">
                                ...
                                <table>
									...
									<tr>
                                        <td>NO APLICA</td>
                                        <td class="t"><input type="radio" name="fo_bloque_dfo" value="No Aplica"/></td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <button name="xfointer"  type = 'button'class="interx" id="xfointer" value="tbfo">Agregar Remate</button>
                        <div style="clear:both"></div>
                        <!--<div class="scsa">
                            <h2>Recuadro 1</h2>
                            <!--<h2>Imagen 1</h2>
                        ...
                        <div class="lf">
                            ...
                            <div class="l" id="a2">
                                ...
                                <table>
									...
									<tr>
                                        <td>NO APLICA</td>
                                        <td class="t"><input type="radio" name="dwfo_bloque_dfo" value="No Aplica"/></td>
                                    </tr>
                                </table>
                            </div>
                            <div style="clear:both"></div>
                    ...
                    <div class="conttwo">
                            ...
                            <div class="contplanos">
                                ...
                                <fieldset class="check">
									...
									<div class="fa">
                                        <input type="checkbox" name="tplan3" value="Plano de sala"/>
                                        <label>Reporte mano alzada proveedor equipo</label>
                                    </div>
                                    <div class="fa">
                                        <input type="checkbox" name="tplan4" value="Plano de trayectoria"/>
                                        <label>Reporte mano alzada proveedor infraestructura</label>
                                    </div>
                                    <div class="fa">
